...
def detect_and_visualize(input_video, output_dir="visualization/output_visualization/detection", 
                        confidence_threshold=0.6, max_frames=None):
    """检测视频并保存可视化结果"""
...
def main():
    ...
    parser.add_argument('--sort-by', default='confidence', choices=['confidence', 'area', 'position'], 
    ...
    parser.add_argument('--color-scheme', default='auto', choices=['auto', 'class_based', 'confidence_based'],
                       help='颜色方案 (默认: auto)')
    ...
    # 执行高级检测可视化
    result = detect_and_visualize_advanced(
